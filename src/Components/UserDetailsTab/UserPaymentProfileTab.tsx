      ...
      <div className="w-full px-8 absolute top-8">
        <div className="flex justify-between">
          <div className="">
            ...
            <p className="font-medium tracking-widest">{`${data.firstName} ${data.lastName}`}</p>
          </div>
          <img className="w-14 h-14" src="https://i.imgur.com/bbPHJVe.png" />
        </div>
        <div className="pt-1">
          <p className="font-light">Card Number</p>
          <p className="font-medium tracking-more-wider">{data.bank.cardNumber}</p>
        </div>
        <div className="pt-6 pr-6">
          <div className="flex justify-between">
            ...
            <div className="">
              ...
              <p className="font-medium tracking-wider text-sm">{data.bank.cardExpire}</p>
            </div>
